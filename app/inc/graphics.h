 ...
 */
int16_t grf_rand(int16_t lim);
void grf_pixel(int16_t x, int16_t y, gfx_color_type color);
void grf_fastVLine(int16_t x, int16_t y, int16_t h, gfx_color_type color);
void grf_fastHLine(int16_t x, int16_t y, int16_t w, gfx_color_type color);
void grf_line(int16_t x1, int16_t y1, int16_t x2, int16_t y2, gfx_color_type color);
void grf_circle(int16_t x0, int16_t y0, int16_t radius, gfx_color_type color);
...
void grf_fillScreen(int16_t color);
