...
parametres(brightness	,""	,u8_val					    ,u8Frmt		    ,chmodAlways	,60		    ,10	        ,100		,1	    ,10	    ,0	,prmLimConst	,prmStepConst	,prmEepSys)
...
parametres(gateway		,""	,ip2_val					,ipAdrFrmt		,chmodNone	    ,0xC0A80101	,0		    ,0xFFFFFFFF	,1		,1		,0	,prmLimVariable	,prmStepVariable,prmEepSys) /* 192.168.1.1 */
